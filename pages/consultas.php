<?php
include('../libraries/php/consultasl.php');
?>
                ...
                <?php if (count($consultas) > 0): ?>
                    <div class="d-flex flex-wrap" style="gap: 1rem; width: 100%;  margin-inline: auto;">
                        <?php foreach ($consultas as $consulta): ?>
                            <div class="card mb-3 flex-fill" style="min-width: 200px; max-width: 350px; margin-bottom: 20px; flex:1;" id="consulta_<?= $consulta['consulta_id'] ?>">
